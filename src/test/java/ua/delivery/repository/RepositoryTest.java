...
public class RepositoryTest {
    ...
    @BeforeEach
    void setUp(){
        customerRepository = new GenericRepository<>(Customer::getFullName, "Customer");
    ...
    void testGetAll(){
        ...
        GenericRepository<Customer> empty = new GenericRepository<>(Customer::getFullName, "Customer");
